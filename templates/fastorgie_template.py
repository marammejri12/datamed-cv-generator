"""
FastorGie Professional CV Template - RED Design
Beautiful red design with AI-classified skills
"""
...
class FastorGieTemplate:
    """FastorGie professional template with AI-classified skills"""
    ...
    def __init__(self, output_path: str):
        ...
        # FastorGie color palette - RED Professional
        self.primary_red = colors.HexColor('#c41e3a')       # FastorGie red
        self.dark_red = colors.HexColor('#8b1a2e')          # Dark red
        self.light_red = colors.HexColor('#ffe6ea')         # Light red background
        self.text_dark = colors.HexColor('#1f2937')         # Dark text
        self.text_gray = colors.HexColor('#6b7280')         # Gray text
        self.bg_light = colors.HexColor('#fafafa')          # Light background
        self.accent_orange = colors.HexColor('#d97706')     # Orange accent
    ...
    def _setup_styles(self):
        ...
        self.title_style = ParagraphStyle(
            'Title',
            fontSize=28,
            textColor=self.dark_red,  # Red for title
            spaceAfter=6,
            alignment=TA_CENTER,
    ...
    def generate(self, data: dict):
        ...
        if data.get('competences_groups'):
            story.extend(self._create_section_header(section_num, "COMPÉTENCES FONCTIONNELLES & TECHNIQUES"))
        ...
        # Next section number for experiences
        ...
        footer = Paragraph(
            '<font size=10 color="#6b7280">www.fastor.com</font>',
    ...
    def _create_logo(self):
        ...
        possible_paths = [
            ...
            os.path.join(base_path, 'image', 'fastorgie.jpg'),
        ...
        for logo_path in possible_paths:
            if os.path.exists(logo_path):
                try:
                    ...
                    print(f"✓ Logo FastorGie chargé: {logo_path}")
                    break
        ...
        if not elements:
            print("⚠ Aucun logo FastorGie trouvé")

        return elements

    def _create_section_header(self, number: int, title: str):
        """Beautiful numbered section header - RED style"""
        elements = []
        ...
        table.setStyle(TableStyle([
            ('BACKGROUND', (0, 0), (0, 0), self.dark_red),
            ('BACKGROUND', (1, 0), (1, 0), self.primary_red),
    ...
    def _create_diplomes(self, diplomes: list):
        ...
        for dip in diplomes:
            ...
            data = [[
                Paragraph(f'<b><font color="#c41e3a" size=12>{annee}</font></b>', self.bold_style),
    ...
    def _create_certifications(self, certifications: list):
        ...
        for cert in certifications:
            ...
            data = [[
                Paragraph(f'<b><font color="#d97706" size=12>{annee}</font></b>', self.bold_style),
    ...
    def _create_dynamic_competences(self, competences_groups: list):
        ...
        for group in competences_groups:
            ...
            table.setStyle(TableStyle([
                ('BACKGROUND', (0, 0), (0, 0), self.light_red),
    ...
    def _create_langues(self, langues: list):
        ...
        table.setStyle(TableStyle([
            ('BACKGROUND', (0, 0), (0, -1), self.light_red),
            ('BOX', (0, 0), (-1, -1), 1, self.light_red),
    ...
    def _create_experiences(self, experiences: list):
        ...
        for idx, exp in enumerate(experiences):
            ...
            # Projets
            if exp.get('projets'):
                content_elements.append(Paragraph('<b>Contexte du projet:</b>', self.bold_style))
